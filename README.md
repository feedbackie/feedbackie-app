...
This container will be deleted after stopping with all data. If you want presist data you need to mount volume to /data directory in the container. The directory should be created before the first run:
